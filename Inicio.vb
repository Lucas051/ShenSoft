...
Public Class Inicio
    ...
    Private Sub panelextension_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles panelextension.Paint

    End Sub

    Private Sub PTBflecha_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PTBflecha.Click

        While (panelextension.Width < 228)
            panelextension.Width += 1
        End While
