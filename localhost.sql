...
--
-- Servidor: localhost
-- Tiempo de generación: 04-09-2018 a las 14:35:29
...
--
CREATE DATABASE `automotora` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `automotora`;
...
--
-- Estructura de tabla para la tabla `vechiculos`
--

CREATE TABLE IF NOT EXISTS `vechiculos` (
  `id_autos` int(11) NOT NULL DEFAULT '0',
  `modelo` varchar(30) DEFAULT NULL,
  `marca` varchar(30) DEFAULT NULL,
...
--
CREATE DATABASE `calculadora` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `calculadora`;
...
CREATE TABLE IF NOT EXISTS `historial` (
  `idanum` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `historial` (`idanum`, `numero`, `numa`, `numb`, `operacion`) VALUES
(44, 5, 254, 249, 'resta'),
(45, 60, 55, 5, 'suma'),
(46, 42, 44, 2, 'resta');
--
...
INSERT INTO `consultorios` (`num`, `descripcion`, `codigo`) VALUES
(1, 'dewqduhwedwedweqfqewfqwd', 1),
(2, 'El Hogar de cuwefwefwewd', 1),
(3, 'El Electricistaefwewd', 2),
(4, 'El Herrerofwewd', 1),
(5, 'El Maderon', 3),
(6, 'Descripcion cortita', 3);
...
INSERT INTO `local` (`nombre`, `codigo`, `ciudad`) VALUES
('Raw', 1, 'Salto'),
('Raap', 2, 'Salto'),
('Raiioap', 3, 'Salto'),
('Rcdsfp', 4, 'Tacurembo'),
...
ALTER TABLE `consultorios`
  ADD CONSTRAINT `consultorios_ibfk_1` FOREIGN KEY (`codigo`) REFERENCES `local` (`codigo`);
--
...
INSERT INTO `articulos` (`ida`, `descripcion`, `precio`, `stock`) VALUES
(1, 'Cuaderno', '32', 200),
(2, 'Marcador', '60', 20),
(3, 'Razer Mouse', '60', 100),
(4, 'Teclado Mouse', '100', 50),
(5, 'Intel i9 8600X', '1000', 70),
(6, 'Gabinete Cooler Master', '150', 40),
(7, 'Placa MSI', '300', 50),
(8, 'Monitor 4K', '700', 73),
(9, 'Arroz', '4435', 32523);
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `ciudad` varchar(25) DEFAULT 'Salto',
  PRIMARY KEY (`idc`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `clientes` (`idc`, `nombre`, `direccion`, `telefono`, `mail`, `ciudad`) VALUES
(0, 'Alberto Juanes', 'Salto 543', 47354678, NULL, 'Salto'),
(1, 'Juan Perez', 'Uruguay 75', 47323567, NULL, 'Salto'),
(2, 'Pedro Weon', 'Yacuy 503', 47336903, NULL, 'Salto'),
(3, 'Jose Faker', 'Chile 1043', 99734567, NULL, 'Salto'),
(4, 'Franco Kirigaya', 'Luis Alberto de HErrera', 99463164, NULL, 'Salto'),
(5, 'Asuna Yuki', 'Artigas 1706', 99124567, NULL, 'Salto'),
(6, 'Juanita Parentina', 'Artigas 567', 6666666, NULL, 'Salto'),
(7, 'A mi ', 'Malvacio 133', 47369884, NULL, 'Salto');
...
INSERT INTO `ventas` (`idc`, `ida`, `fecha`, `cantidad`) VALUES
(4, 5, '2018-04-17', 1),
(3, 5, '2018-04-17', 5),
(1, 2, '2018-04-17', 7),
(5, 7, '2018-04-17', 3),
...
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`ida`) REFERENCES `articulos` (`ida`),
  ADD CONSTRAINT `ventas_ibfk_3` FOREIGN KEY (`idc`) REFERENCES `clientes` (`idc`);
--
-- Base de datos: `escritoiii`
--
CREATE DATABASE `escritoiii` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `escritoiii`;
...
INSERT INTO `clientes` (`idcli`, `nombre`) VALUES
(4, 'Andrés'),
(5, 'José'),
(6, 'Jorge');
...
--
ALTER TABLE `compras`
  ADD CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`idcli`) REFERENCES `clientes` (`idcli`);
--
-- Base de datos: `escritostock`
--
CREATE DATABASE `escritostock` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `escritostock`;
...
--
-- Base de datos: `informaciondepersonas`
--
CREATE DATABASE `informaciondepersonas` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `informaciondepersonas`;
...
('def', 'automotora', 'autos', 'vehiculos_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'automotora', 'autos', 'modelo', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'automotora', 'autos', 'marca', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'automotora', 'vechiculos', 'id_autos', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'automotora', 'vechiculos', 'modelo', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'automotora', 'vechiculos', 'marca', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'calculadora', 'historial', 'idanum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'calculadora', 'historial', 'numero', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'calculadora', 'historial', 'numa', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'calculadora', 'historial', 'numb', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'calculadora', 'historial', 'operacion', 5, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'clinica', 'consultorios', 'num', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'clinica', 'consultorios', 'descripcion', 2, NULL, 'YES', 'char', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(50)', '', '', 'select,insert,update,references', ''),
('def', 'clinica', 'consultorios', 'codigo', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'clinica', 'local', 'nombre', 1, NULL, 'YES', 'char', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(30)', '', '', 'select,insert,update,references', ''),
('def', 'clinica', 'local', 'codigo', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'clinica', 'local', 'ciudad', 3, NULL, 'YES', 'char', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(30)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'articulos', 'ida', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'comercio', 'articulos', 'descripcion', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'articulos', 'precio', 3, NULL, 'YES', 'decimal', NULL, NULL, 10, 0, NULL, NULL, 'decimal(10,0)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'articulos', 'stock', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'clientes', 'idc', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'comercio', 'clientes', 'nombre', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'clientes', 'direccion', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'clientes', 'telefono', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'clientes', 'mail', 5, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'clientes', 'ciudad', 6, 'Salto', 'YES', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'ventas', 'idc', 1, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'comercio', 'ventas', 'ida', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'comercio', 'ventas', 'fecha', 3, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'comercio', 'ventas', 'cantidad', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'escritoiii', 'clientes', 'idcli', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'escritoiii', 'clientes', 'nombre', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'escritoiii', 'compras', 'idcompra', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'escritoiii', 'compras', 'idcli', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'escritoiii', 'compras', 'Nombre', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'escritostock', 'stock', 'idstock', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'escritostock', 'stock', 'marca', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'escritostock', 'stock', 'tipo', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'escritostock', 'stock', 'tamaño', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'escritostock', 'stock', 'fechavencimiento', 5, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'escritostock', 'stock', 'descripcion', 6, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'idper', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'nombre', 2, NULL, 'YES', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'apellido', 3, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'edad', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'fecha_nacimiento', 5, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'direccion', 6, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'informaciondepersonas', 'personas', 'sexo', 7, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
...
('def', 'proyecto', 'clientes', 'num_cliente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'clientes', 'CI', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'clientes', 'nombre_cliente', 3, NULL, 'YES', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'clientes', 'saldo_c', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'clientes', 'direccion_c', 5, NULL, 'YES', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'clientes', 'tel_c', 6, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'factura_prov', 'n_factura_prov', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'factura_prov', 'fecha', 2, 'CURRENT_TIMESTAMP', 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
('def', 'proyecto', 'factura_prov', 'monto', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'factura_prov', 'num_prov', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'facturas', 'n_factura', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'facturas', 'fecha', 2, 'CURRENT_TIMESTAMP', 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
('def', 'proyecto', 'facturas', 'monto', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'facturas', 'num_cliente', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'facturas', 'forma_de_pago', 5, NULL, 'YES', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'genera', 'n_factura', 1, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'genera', 'precio_v', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'genera', 'cantidad', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'genera', 'cod_producto', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_clientes', 'num_recibo_c', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_clientes', 'fecha', 2, 'CURRENT_TIMESTAMP', 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_clientes', 'importe', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_clientes', 'num_cliente', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_prov', 'n_recibo_prov', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_prov', 'fecha', 2, 'CURRENT_TIMESTAMP', 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_prov', 'importe', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'pagos_prov', 'num_prov', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'proveedores', 'num_prov', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'proveedores', 'nombre_prov', 2, NULL, 'YES', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'proveedores', 'tel_p', 3, NULL, 'YES', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'proveedores', 'direccion_p', 4, NULL, 'YES', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'proveedores', 'saldo_p', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'stock', 'cod_producto', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'proyecto', 'stock', 'descripcion', 2, NULL, 'YES', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'stock', 'cantidad', 3, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'stock', 'precio_costo', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'stock', 'precio_v_stock', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'proyecto', 'stock', 'num_prov', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'registro', 'funcionarios', 'c_i', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'registro', 'funcionarios', 'nombre_completo', 2, NULL, 'YES', 'char', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(30)', '', '', 'select,insert,update,references', ''),
('def', 'registro', 'funcionarios', 'cargo', 3, NULL, 'YES', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
('def', 'registro', 'funcionarios', 'fecha_ingreso', 4, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'registro', 'horarios', 'cod_horarios', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'registro', 'horarios', 'cedula', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'registro', 'horarios', 'fecha', 3, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'registro', 'horarios', 'hora_e', 4, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
('def', 'registro', 'horarios', 'hora_s', 5, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', '');
...
('INNODB_BUFFER_POOL_PAGES_FREE', '7786'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '9315'),
...
('INNODB_DATA_READ', '8851456'),
('INNODB_DATA_READS', '417'),
...
('KEY_BLOCKS_UNUSED', '13388'),
('KEY_BLOCKS_USED', '8'),
('KEY_READ_REQUESTS', '122'),
('KEY_READS', '16'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '3104'),
('UPTIME_SINCE_FLUSH_STATUS', '3104');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Ignacio-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Ignacio-PC.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Ignacio-PC-slow.log'),
...
('def', 'automotora', 'PRIMARY', 'def', 'automotora', 'autos', 'vehiculos_id', 1, NULL, NULL, NULL, NULL),
('def', 'automotora', 'PRIMARY', 'def', 'automotora', 'vechiculos', 'id_autos', 1, NULL, NULL, NULL, NULL),
('def', 'calculadora', 'PRIMARY', 'def', 'calculadora', 'historial', 'idanum', 1, NULL, NULL, NULL, NULL),
('def', 'clinica', 'PRIMARY', 'def', 'clinica', 'consultorios', 'num', 1, NULL, NULL, NULL, NULL),
('def', 'clinica', 'consultorios_ibfk_1', 'def', 'clinica', 'consultorios', 'codigo', 1, 1, 'clinica', 'local', 'codigo'),
('def', 'clinica', 'PRIMARY', 'def', 'clinica', 'local', 'codigo', 1, NULL, NULL, NULL, NULL),
('def', 'comercio', 'PRIMARY', 'def', 'comercio', 'articulos', 'ida', 1, NULL, NULL, NULL, NULL),
('def', 'comercio', 'PRIMARY', 'def', 'comercio', 'clientes', 'idc', 1, NULL, NULL, NULL, NULL),
('def', 'comercio', 'ventas_ibfk_2', 'def', 'comercio', 'ventas', 'ida', 1, 1, 'comercio', 'articulos', 'ida'),
('def', 'comercio', 'ventas_ibfk_3', 'def', 'comercio', 'ventas', 'idc', 1, 1, 'comercio', 'clientes', 'idc'),
('def', 'escritoiii', 'PRIMARY', 'def', 'escritoiii', 'clientes', 'idcli', 1, NULL, NULL, NULL, NULL),
('def', 'escritoiii', 'PRIMARY', 'def', 'escritoiii', 'compras', 'idcompra', 1, NULL, NULL, NULL, NULL),
('def', 'escritoiii', 'compras_ibfk_1', 'def', 'escritoiii', 'compras', 'idcli', 1, 1, 'escritoiii', 'clientes', 'idcli'),
('def', 'escritostock', 'PRIMARY', 'def', 'escritostock', 'stock', 'idstock', 1, NULL, NULL, NULL, NULL),
('def', 'informaciondepersonas', 'PRIMARY', 'def', 'informaciondepersonas', 'personas', 'idper', 1, NULL, NULL, NULL, NULL),
...
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'clientes', 'num_cliente', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'factura_prov', 'n_factura_prov', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'factura_prov_ibfk_1', 'def', 'proyecto', 'factura_prov', 'num_prov', 1, 1, 'proyecto', 'proveedores', 'num_prov'),
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'facturas', 'n_factura', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'facturas_ibfk_1', 'def', 'proyecto', 'facturas', 'num_cliente', 1, 1, 'proyecto', 'clientes', 'num_cliente'),
('def', 'proyecto', 'genera_ibfk_1', 'def', 'proyecto', 'genera', 'n_factura', 1, 1, 'proyecto', 'facturas', 'n_factura'),
('def', 'proyecto', 'genera_ibfk_2', 'def', 'proyecto', 'genera', 'cod_producto', 1, 1, 'proyecto', 'stock', 'cod_producto'),
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'pagos_clientes', 'num_recibo_c', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'pagos_clientes_ibfk_1', 'def', 'proyecto', 'pagos_clientes', 'num_cliente', 1, 1, 'proyecto', 'clientes', 'num_cliente'),
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'pagos_prov', 'n_recibo_prov', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'pagos_prov_ibfk_1', 'def', 'proyecto', 'pagos_prov', 'num_prov', 1, 1, 'proyecto', 'proveedores', 'num_prov'),
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'proveedores', 'num_prov', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'PRIMARY', 'def', 'proyecto', 'stock', 'cod_producto', 1, NULL, NULL, NULL, NULL),
('def', 'proyecto', 'stock_ibfk_1', 'def', 'proyecto', 'stock', 'num_prov', 1, 1, 'proyecto', 'proveedores', 'num_prov'),
('def', 'registro', 'PRIMARY', 'def', 'registro', 'funcionarios', 'c_i', 1, NULL, NULL, NULL, NULL),
('def', 'registro', 'PRIMARY', 'def', 'registro', 'horarios', 'cod_horarios', 1, NULL, NULL, NULL, NULL),
('def', 'registro', 'horarios_ibfk_1', 'def', 'registro', 'horarios', 'cedula', 1, 1, 'registro', 'funcionarios', 'c_i');
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-09-04 14:35:33', '2018-09-04 14:35:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2018-09-04 14:35:33', NULL, NULL, NULL, '', '', NULL),
('def', 'automotora', 'autos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 5242880, '2018-05-09 13:59:49', NULL, NULL, NULL, '', '', NULL),
('def', 'automotora', 'vechiculos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 5242880, '2018-05-09 13:59:06', NULL, NULL, NULL, '', '', NULL),
('def', 'calculadora', 'historial', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 5242880, '2018-06-13 16:13:21', NULL, NULL, NULL, '', '', NULL),
('def', 'clinica', 'consultorios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 16384, 5242880, '2017-11-03 18:24:09', NULL, NULL, NULL, '', '', NULL),
('def', 'clinica', 'local', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 5242880, '2017-11-03 17:53:15', NULL, NULL, NULL, '', '', NULL),
('def', 'comercio', 'articulos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 0, 5242880, '2018-05-29 14:30:31', NULL, NULL, NULL, '', '', NULL),
('def', 'comercio', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 0, 5242880, '2018-05-29 14:30:32', NULL, NULL, NULL, '', '', NULL),
('def', 'comercio', 'ventas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 32768, 5242880, '2018-05-29 14:30:32', NULL, NULL, NULL, '', '', NULL),
('def', 'escritoiii', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 5242880, '2018-06-27 11:58:55', NULL, NULL, NULL, '', '', NULL),
('def', 'escritoiii', 'compras', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 5242880, '2018-06-27 12:22:06', NULL, NULL, NULL, '', '', NULL),
('def', 'escritostock', 'stock', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 5242880, '2018-06-27 13:31:43', NULL, NULL, NULL, '', '', NULL),
('def', 'informaciondepersonas', 'personas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 5242880, '2018-08-08 13:30:15', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 440, 3080, 123848989752688639, 5120, 0, '2012-04-19 13:45:09', '2018-09-04 14:26:29', '2012-04-19 13:45:10', NULL, '', '', NULL),
...
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 851, 10212, 239535205180768255, 8192, 0, '2012-04-19 13:45:09', '2018-09-04 14:28:07', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 83, 916, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2018-09-04 14:17:14', NULL, NULL, '', '', NULL),
...
('def', 'proyecto', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-08-07 15:27:58', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'factura_prov', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-08-07 15:28:00', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'facturas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-08-07 15:28:00', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'genera', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2018-08-07 15:28:01', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'pagos_clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-08-07 15:28:01', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'pagos_prov', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-08-07 15:28:01', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'proveedores', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2018-08-07 15:27:59', NULL, NULL, NULL, '', '', NULL),
('def', 'proyecto', 'stock', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 0, '2018-08-07 15:28:02', NULL, NULL, NULL, '', '', NULL),
('def', 'registro', 'funcionarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2017-10-31 20:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'registro', 'horarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 0, '2017-10-31 20:17:55', NULL, NULL, NULL, '', '', NULL);
...
(8, 'root', 'localhost:54435', 'informaciondepersonas', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'clinica', 'consultorios_ibfk_1', 'def', 'clinica', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'consultorios', 'local'),
('def', 'comercio', 'ventas_ibfk_2', 'def', 'comercio', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'ventas', 'articulos'),
('def', 'comercio', 'ventas_ibfk_3', 'def', 'comercio', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'ventas', 'clientes'),
('def', 'escritoiii', 'compras_ibfk_1', 'def', 'escritoiii', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'compras', 'clientes'),
('def', 'proyecto', 'factura_prov_ibfk_1', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'factura_prov', 'proveedores'),
('def', 'proyecto', 'facturas_ibfk_1', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'facturas', 'clientes'),
('def', 'proyecto', 'genera_ibfk_1', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'genera', 'facturas'),
('def', 'proyecto', 'genera_ibfk_2', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'genera', 'stock'),
('def', 'proyecto', 'pagos_clientes_ibfk_1', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'pagos_clientes', 'clientes'),
('def', 'proyecto', 'pagos_prov_ibfk_1', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'pagos_prov', 'proveedores'),
('def', 'proyecto', 'stock_ibfk_1', 'def', 'proyecto', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'stock', 'proveedores'),
('def', 'registro', 'horarios_ibfk_1', 'def', 'registro', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'horarios', 'funcionarios');
...
('def', 'automotora', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'calculadora', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'clinica', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'comercio', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'escritoiii', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'escritostock', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'informaciondepersonas', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'proyecto', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'registro', 'latin1', 'latin1_swedish_ci', NULL),
...
('''Admin''@''localhost''', 'def', 'proyecto', 'SELECT', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'INSERT', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'UPDATE', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'DELETE', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'CREATE', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'DROP', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'REFERENCES', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'INDEX', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'ALTER', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'CREATE TEMPORARY TABLES', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'LOCK TABLES', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'EXECUTE', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'CREATE VIEW', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'SHOW VIEW', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'CREATE ROUTINE', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'ALTER ROUTINE', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'EVENT', 'NO'),
('''Admin''@''localhost''', 'def', 'proyecto', 'TRIGGER', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'SELECT', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'INSERT', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'UPDATE', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'DELETE', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'CREATE', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'DROP', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'REFERENCES', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'INDEX', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'ALTER', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'CREATE TEMPORARY TABLES', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'LOCK TABLES', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'EXECUTE', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'CREATE VIEW', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'SHOW VIEW', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'CREATE ROUTINE', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'ALTER ROUTINE', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'EVENT', 'NO'),
('''Administrador''@''localhost''', 'def', 'proyecto', 'TRIGGER', 'NO'),
('''Dueño''@''localhost''', 'def', 'proyecto', 'SELECT', 'NO'),
('''Dueño''@''localhost''', 'def', 'proyecto', 'INSERT', 'NO'),
('''Dueño''@''localhost''', 'def', 'proyecto', 'UPDATE', 'NO'),
('''Dueño''@''localhost''', 'def', 'proyecto', 'DELETE', 'NO'),
('''Gerente''@''localhost''', 'def', 'proyecto', 'SELECT', 'NO'),
('''Empleados''@''localhost''', 'def', 'proyecto', 'SELECT', 'NO'),
('''''@''%''', 'def', 'test', 'SELECT', 'NO'),
('''''@''%''', 'def', 'test', 'INSERT', 'NO'),
('''''@''%''', 'def', 'test', 'UPDATE', 'NO'),
('''''@''%''', 'def', 'test', 'DELETE', 'NO'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '9'),
('CREATED_TMP_DISK_TABLES', '126'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '389'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '0'),
('FLUSH_COMMANDS', '1'),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2558'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2508'),
('INNODB_BUFFER_POOL_PAGES_DATA', '425'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '1'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '0'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '10406'),
...
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '9162752'),
('INNODB_DATA_READS', '436'),
('INNODB_DATA_WRITES', '4'),
('INNODB_DATA_WRITTEN', '2048'),
('INNODB_DBLWR_PAGES_WRITTEN', '0'),
('INNODB_DBLWR_WRITES', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '3105'),
('UPTIME_SINCE_FLUSH_STATUS', '3105');
...
('def', 'automotora', 'autos', 0, 'automotora', 'PRIMARY', 1, 'vehiculos_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'automotora', 'vechiculos', 0, 'automotora', 'PRIMARY', 1, 'id_autos', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'calculadora', 'historial', 0, 'calculadora', 'PRIMARY', 1, 'idanum', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'clinica', 'consultorios', 0, 'clinica', 'PRIMARY', 1, 'num', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'clinica', 'consultorios', 1, 'clinica', 'codigo', 1, 'codigo', 'A', 6, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'clinica', 'local', 0, 'clinica', 'PRIMARY', 1, 'codigo', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'comercio', 'articulos', 0, 'comercio', 'PRIMARY', 1, 'ida', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'comercio', 'clientes', 0, 'comercio', 'PRIMARY', 1, 'idc', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'comercio', 'ventas', 1, 'comercio', 'ida', 1, 'ida', 'A', 10, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'comercio', 'ventas', 1, 'comercio', 'idc', 1, 'idc', 'A', 10, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'escritoiii', 'clientes', 0, 'escritoiii', 'PRIMARY', 1, 'idcli', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'escritoiii', 'compras', 0, 'escritoiii', 'PRIMARY', 1, 'idcompra', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'escritoiii', 'compras', 1, 'escritoiii', 'idcli', 1, 'idcli', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'escritostock', 'stock', 0, 'escritostock', 'PRIMARY', 1, 'idstock', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'informaciondepersonas', 'personas', 0, 'informaciondepersonas', 'PRIMARY', 1, 'idper', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'db', 0, 'mysql', 'PRIMARY', 3, 'User', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'db', 1, 'mysql', 'User', 1, 'User', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'tables_priv', 0, 'mysql', 'PRIMARY', 4, 'Table_name', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'user', 0, 'mysql', 'PRIMARY', 2, 'User', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'clientes', 0, 'proyecto', 'PRIMARY', 1, 'num_cliente', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'factura_prov', 0, 'proyecto', 'PRIMARY', 1, 'n_factura_prov', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'factura_prov', 1, 'proyecto', 'num_prov', 1, 'num_prov', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'proyecto', 'facturas', 0, 'proyecto', 'PRIMARY', 1, 'n_factura', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'facturas', 1, 'proyecto', 'num_cliente', 1, 'num_cliente', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'proyecto', 'genera', 1, 'proyecto', 'n_factura', 1, 'n_factura', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'proyecto', 'genera', 1, 'proyecto', 'cod_producto', 1, 'cod_producto', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'proyecto', 'pagos_clientes', 0, 'proyecto', 'PRIMARY', 1, 'num_recibo_c', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'pagos_clientes', 1, 'proyecto', 'num_cliente', 1, 'num_cliente', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'proyecto', 'pagos_prov', 0, 'proyecto', 'PRIMARY', 1, 'n_recibo_prov', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'pagos_prov', 1, 'proyecto', 'num_prov', 1, 'num_prov', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'proyecto', 'proveedores', 0, 'proyecto', 'PRIMARY', 1, 'num_prov', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'stock', 0, 'proyecto', 'PRIMARY', 1, 'cod_producto', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'proyecto', 'stock', 1, 'proyecto', 'num_prov', 1, 'num_prov', 'A', 3, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'registro', 'funcionarios', 0, 'registro', 'PRIMARY', 1, 'c_i', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'registro', 'horarios', 0, 'registro', 'PRIMARY', 1, 'cod_horarios', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'registro', 'horarios', 1, 'registro', 'cedula', 1, 'cedula', 'A', 2, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-09-04 14:35:34', '2018-09-04 14:35:34', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2018-09-04 14:35:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'automotora', 'autos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-05-09 13:59:49', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'automotora', 'vechiculos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2018-05-09 13:59:06', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'calculadora', 'historial', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 5242880, 47, '2018-06-13 16:13:21', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'clinica', 'consultorios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 16384, 5242880, NULL, '2017-11-03 18:24:09', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'clinica', 'local', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 5242880, NULL, '2017-11-03 17:53:15', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'comercio', 'articulos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 0, 5242880, NULL, '2018-05-29 14:30:31', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'comercio', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 0, 5242880, NULL, '2018-05-29 14:30:32', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'comercio', 'ventas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 5242880, NULL, '2018-05-29 14:30:32', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'escritoiii', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 5242880, 7, '2018-06-27 11:58:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'escritoiii', 'compras', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-06-27 12:22:06', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'escritostock', 'stock', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-06-27 13:31:43', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'informaciondepersonas', 'personas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-08-08 13:30:15', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 7, 440, 3080, 123848989752688639, 5120, 0, NULL, '2012-04-19 13:45:09', '2018-09-04 14:26:29', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'Database privileges'),
...
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 12, 851, 10212, 239535205180768255, 8192, 0, NULL, '2012-04-19 13:45:09', '2018-09-04 14:28:07', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 83, 916, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2018-09-04 14:17:14', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'proyecto', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-08-07 15:27:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'factura_prov', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-08-07 15:28:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'facturas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-08-07 15:28:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'genera', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2018-08-07 15:28:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'pagos_clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-08-07 15:28:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'pagos_prov', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, 1, '2018-08-07 15:28:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'proveedores', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, 1, '2018-08-07 15:27:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'proyecto', 'stock', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 5242880, 4, '2018-08-07 15:28:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'registro', 'funcionarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 5242880, NULL, '2017-10-31 20:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'registro', 'horarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 5242880, 3, '2017-10-31 20:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'automotora', 'PRIMARY', 'automotora', 'autos', 'PRIMARY KEY'),
('def', 'automotora', 'PRIMARY', 'automotora', 'vechiculos', 'PRIMARY KEY'),
('def', 'calculadora', 'PRIMARY', 'calculadora', 'historial', 'PRIMARY KEY'),
('def', 'clinica', 'PRIMARY', 'clinica', 'consultorios', 'PRIMARY KEY'),
('def', 'clinica', 'consultorios_ibfk_1', 'clinica', 'consultorios', 'FOREIGN KEY'),
('def', 'clinica', 'PRIMARY', 'clinica', 'local', 'PRIMARY KEY'),
('def', 'comercio', 'PRIMARY', 'comercio', 'articulos', 'PRIMARY KEY'),
('def', 'comercio', 'PRIMARY', 'comercio', 'clientes', 'PRIMARY KEY'),
('def', 'comercio', 'ventas_ibfk_2', 'comercio', 'ventas', 'FOREIGN KEY'),
('def', 'comercio', 'ventas_ibfk_3', 'comercio', 'ventas', 'FOREIGN KEY'),
('def', 'escritoiii', 'PRIMARY', 'escritoiii', 'clientes', 'PRIMARY KEY'),
('def', 'escritoiii', 'PRIMARY', 'escritoiii', 'compras', 'PRIMARY KEY'),
('def', 'escritoiii', 'compras_ibfk_1', 'escritoiii', 'compras', 'FOREIGN KEY'),
('def', 'escritostock', 'PRIMARY', 'escritostock', 'stock', 'PRIMARY KEY'),
('def', 'informaciondepersonas', 'PRIMARY', 'informaciondepersonas', 'personas', 'PRIMARY KEY'),
...
('def', 'proyecto', 'PRIMARY', 'proyecto', 'clientes', 'PRIMARY KEY'),
('def', 'proyecto', 'PRIMARY', 'proyecto', 'factura_prov', 'PRIMARY KEY'),
('def', 'proyecto', 'factura_prov_ibfk_1', 'proyecto', 'factura_prov', 'FOREIGN KEY'),
('def', 'proyecto', 'PRIMARY', 'proyecto', 'facturas', 'PRIMARY KEY'),
('def', 'proyecto', 'facturas_ibfk_1', 'proyecto', 'facturas', 'FOREIGN KEY'),
('def', 'proyecto', 'genera_ibfk_1', 'proyecto', 'genera', 'FOREIGN KEY'),
('def', 'proyecto', 'genera_ibfk_2', 'proyecto', 'genera', 'FOREIGN KEY'),
('def', 'proyecto', 'PRIMARY', 'proyecto', 'pagos_clientes', 'PRIMARY KEY'),
('def', 'proyecto', 'pagos_clientes_ibfk_1', 'proyecto', 'pagos_clientes', 'FOREIGN KEY'),
('def', 'proyecto', 'PRIMARY', 'proyecto', 'pagos_prov', 'PRIMARY KEY'),
('def', 'proyecto', 'pagos_prov_ibfk_1', 'proyecto', 'pagos_prov', 'FOREIGN KEY'),
('def', 'proyecto', 'PRIMARY', 'proyecto', 'proveedores', 'PRIMARY KEY'),
('def', 'proyecto', 'PRIMARY', 'proyecto', 'stock', 'PRIMARY KEY'),
('def', 'proyecto', 'stock_ibfk_1', 'proyecto', 'stock', 'FOREIGN KEY'),
('def', 'registro', 'PRIMARY', 'registro', 'funcionarios', 'PRIMARY KEY'),
('def', 'registro', 'PRIMARY', 'registro', 'horarios', 'PRIMARY KEY'),
('def', 'registro', 'horarios_ibfk_1', 'registro', 'horarios', 'FOREIGN KEY');
...
--
-- Volcado de datos para la tabla `TABLE_PRIVILEGES`
--

INSERT INTO `TABLE_PRIVILEGES` (`GRANTEE`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PRIVILEGE_TYPE`, `IS_GRANTABLE`) VALUES
('''Gerente''@''localhost''', 'def', 'proyecto', 'facturas', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'SELECT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'UPDATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'DELETE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'CREATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'DROP', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'REFERENCES', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'INDEX', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'ALTER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'CREATE VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'SHOW VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'pagos_clientes', 'TRIGGER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'SELECT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'UPDATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'DELETE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'CREATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'DROP', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'REFERENCES', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'INDEX', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'ALTER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'CREATE VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'SHOW VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'stock', 'TRIGGER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'SELECT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'UPDATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'DELETE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'CREATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'DROP', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'REFERENCES', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'INDEX', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'ALTER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'CREATE VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'SHOW VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'clientes', 'TRIGGER', 'NO'),
('''Empleados''@''localhost''', 'def', 'proyecto', 'genera', 'INSERT', 'NO'),
('''Gerente''@''localhost''', 'def', 'proyecto', 'stock', 'INSERT', 'NO'),
('''Gerente''@''localhost''', 'def', 'proyecto', 'clientes', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'SELECT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'UPDATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'DELETE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'CREATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'DROP', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'REFERENCES', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'INDEX', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'ALTER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'CREATE VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'SHOW VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'facturas', 'TRIGGER', 'NO'),
('''Empleados''@''localhost''', 'def', 'proyecto', 'facturas', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'SELECT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'UPDATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'DELETE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'CREATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'DROP', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'REFERENCES', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'INDEX', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'ALTER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'CREATE VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'SHOW VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'factura_prov', 'TRIGGER', 'NO'),
('''Gerente''@''localhost''', 'def', 'proyecto', 'genera', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'SELECT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'INSERT', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'UPDATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'DELETE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'CREATE', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'DROP', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'REFERENCES', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'INDEX', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'ALTER', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'CREATE VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'SHOW VIEW', 'NO'),
('''GERENTE''@''localhost''', 'def', 'proyecto', 'genera', 'TRIGGER', 'NO');
...
('''Empleados''@''localhost''', 'def', 'USAGE', 'NO'),
('''Dueño''@''localhost''', 'def', 'USAGE', 'NO'),
...
('''GERENTE''@''localhost''', 'def', 'USAGE', 'NO'),
('''Admin''@''localhost''', 'def', 'USAGE', 'NO'),
('''Administrador''@''localhost''', 'def', 'USAGE', 'NO'),
('''Gerente''@''localhost''', 'def', 'USAGE', 'NO'),
('''nombre_usuario''@''localhost''', 'def', 'USAGE', 'NO'),
...
('localhost', 'proyecto', 'Admin', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'proyecto', 'Administrador', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'proyecto', 'Dueño', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N'),
('localhost', 'proyecto', 'Gerente', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N'),
('localhost', 'proyecto', 'Empleados', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N');
...
('localhost', 'proyecto', 'GERENTE', 'clientes', 'root@localhost', '2018-07-25 22:22:18', 'Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger', ''),
('localhost', 'proyecto', 'GERENTE', 'facturas', 'root@localhost', '2018-07-25 22:22:32', 'Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger', ''),
('localhost', 'proyecto', 'GERENTE', 'factura_prov', 'root@localhost', '2018-07-25 22:22:28', 'Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger', ''),
('localhost', 'proyecto', 'GERENTE', 'genera', 'root@localhost', '2018-07-25 22:22:38', 'Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger', ''),
('localhost', 'proyecto', 'GERENTE', 'pagos_clientes', 'root@localhost', '2018-07-25 22:22:49', 'Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger', ''),
('localhost', 'proyecto', 'GERENTE', 'stock', 'root@localhost', '2018-07-25 22:22:59', 'Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger', ''),
('localhost', 'proyecto', 'Gerente', 'stock', 'root@localhost', '2018-09-04 14:19:29', 'Insert', ''),
('localhost', 'proyecto', 'Gerente', 'facturas', 'root@localhost', '2018-09-04 14:19:38', 'Insert', ''),
('localhost', 'proyecto', 'Gerente', 'clientes', 'root@localhost', '2018-09-04 14:19:46', 'Insert', ''),
('localhost', 'proyecto', 'Empleados', 'facturas', 'root@localhost', '2018-09-04 14:26:39', 'Insert', ''),
('localhost', 'proyecto', 'Empleados', 'genera', 'root@localhost', '2018-09-04 14:27:48', 'Insert', ''),
('localhost', 'proyecto', 'Gerente', 'genera', 'root@localhost', '2018-09-04 14:28:02', 'Insert', '');
...
('localhost', 'GERENTE', '*A0E2FA8260291E65C4CC18B1254053E30EAD6A71', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'Admin', '*F2CCCDBFBC653F3946AB21B3DA9496EB043E6AFB', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'Empleados', '*97F59DF2C594E86A89A5F5BAB230D5E766BB02C1', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'nombre_usuario', '*307431624C2C6934E453572132D121C83FB38B92', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'Administrador', '*D89A99106002D77C1D327FC41E005919505638B0', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'Dueño', '*62F39180D3D728ABCB6B46B6CA5B0E35A7F45DFE', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'Gerente', '*E27C72862393433815CDC365B1A33B218F31AAD2', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
...
(1, 'asdasd', '0', 321, 444, NULL),
(2, 'asdasd', '0', 233, 4444, NULL),
(3, 'Hola anduvo', '0', 234, 3333, NULL);
...
CREATE TABLE IF NOT EXISTS `funcionarios` (
  `c_i` int(11) NOT NULL,
  `nombre_completo` char(30) DEFAULT NULL,
...
INSERT INTO `funcionarios` (`c_i`, `nombre_completo`, `cargo`, `fecha_ingreso`) VALUES
(123, 'qwe', 'asd', NULL),
(4657, 'Manuel Mandiola', 'Profe', NULL),
(53353391, 'Ignacio Etchepare', 'Administrador', NULL);
...
CREATE TABLE IF NOT EXISTS `horarios` (
  `cod_horarios` int(11) NOT NULL AUTO_INCREMENT,
  `cedula` int(11) NOT NULL,
  `fecha` date DEFAULT NULL,
  `hora_e` time DEFAULT NULL,
  `hora_s` time DEFAULT NULL,
  PRIMARY KEY (`cod_horarios`),
  KEY `cedula` (`cedula`)
...
INSERT INTO `horarios` (`cod_horarios`, `cedula`, `fecha`, `hora_e`, `hora_s`) VALUES
(1, 123, NULL, '17:51:56', NULL),
(2, 123, NULL, NULL, '17:53:30');
...
ALTER TABLE `horarios`
  ADD CONSTRAINT `horarios_ibfk_1` FOREIGN KEY (`cedula`) REFERENCES `funcionarios` (`c_i`);
--
-- Base de datos: `test`
--
