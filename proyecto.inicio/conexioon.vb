...
Imports System.Data
Module conexioon
    Dim ubicacion As String = "server=localhost ; user id=root ; password=;database =proyecto" ' "server=proyectoxd.ddns.net; user id=admin; password=admin; database=proyecto" 'aca se modifico para la base de datos remota
