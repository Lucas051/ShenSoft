Public Class FacturasProveedores
    ...
    Private Sub FacturasProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            conexioon.Consulta = "SELECT FP.n_factura_prov, FP.fecha_p, FP.num_prov, P.nombre_prov, FP.monto, FP.forma_de_pago FROM factura_prov FP inner join proveedores P on FP.num_prov=P.Num_prov;"
            consultar()
    ...
    Private Sub btnSuspender_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSuspender.Click
        ...
        Dim opcion As DialogResult
        opcion = MessageBox.Show("Realmente desea Suspender Factura N° '" + lblNfactura.Text + "' de " + txtproveedor.Text + " ?", "Suspender Factura", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
